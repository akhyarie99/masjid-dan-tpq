  ...
  <AdminLayout title="Absensi Santri">
    ...
    <AppCard class="max-w-md">
      <form class="space-y-4" @submit.prevent="go">
        ...
        <AppButton type="submit" class="w-full justify-center" :disabled="!classId">Buka Absensi</AppButton>
      </form>
    </AppCard>
  </AdminLayout>
</template>
...
function go() {
  router.get(route('admin.tpq.attendance.show', classId.value), { date: date.value })
}
</script>
